...
def create_radar_chart(df, players, id_column, title=None, padding=1.25):
    ...
    ax.legend(loc='lower left', bbox_to_anchor=(0.1, 0.1), facecolor='white', edgecolor='black', labelcolor='black')
...
######################################################Center Back#############################################    
    ...
    weights=[-0.5,1,0.5,1,0.6,1,-0.2,1,0.5,0.9,-0.8,0.5,0.8,0.5,0.8]
